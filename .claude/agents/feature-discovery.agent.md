...
- How does this align with our current app's value proposition? (Read `README.md` or `CLAUDE.md` to understand the app's current purpose).
...
End exactly with:
"**Feature discovery complete.** The concept is now ready for technical breakdown and requirements engineering."
